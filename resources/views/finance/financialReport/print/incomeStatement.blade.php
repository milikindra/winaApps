            ...
            <table class="table tableBorder" id="tr" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 10%; text-align:right;border-left:none;"><strong>{{accDollars($b->persen)}}%</strong></td>
                        @else
                        ...
                        <td style="width: 10%; text-align:right;border-left:none;">{{accDollars($b->persen)}}%</td>
                        @endif
                    </tr>
                    @endforeach
                </tbody>
