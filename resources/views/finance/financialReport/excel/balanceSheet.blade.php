            ...
            <table class="table tableBorder" id="tr" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-family: helvetica,sans-serif;font-size: 10px; border: thin solid black; text-align:right;font-weight: bold;" width="7%">{{$b->valas}}</td>
                        @else
                        ...
                        <td style="font-family: helvetica,sans-serif;font-size: 10px; border: thin solid black; text-align:right" width="7%">{{$b->valas}}</td>
                        @endif
                    </tr>
                    @endforeach
                </tbody>
